...
\begin{center}\includegraphics[width=0.8\linewidth]{figurasR/unnamed-chunk-14-1} \end{center}
...
{\centering \includegraphics[width=0.8\linewidth]{figurasR/unnamed-chunk-15-1} 

}

\caption{\label{fig:cap05gg02}Gr\'afico de L\'{\i}aneas creado con ggplot2. Fuente: elaboraci\'on propia}\label{fig:unnamed-chunk-15}
\end{figure}
...
\caption{\label{tab:unnamed-chunk-17}\label{tabla02}Leyenda explicativa de la segunda tabla}
\centering
...
\caption{\label{tab:unnamed-chunk-21}\label{tab:apaisada}Esta tabla 
...
\NormalTok{\textbackslash{}nocite\{Luque2017,Luque2019,RStudio,R{-}base,}
